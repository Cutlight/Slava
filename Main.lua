--[[
    ...
    Rebranded as Slava v9, Cutlight#0311

    (Note from Herrtt)  I decided to make it open source for all the new scripters out there (including me), don't ripoff or claim this as your own.
...
warn("SLAVA_MAIN : Reached end of script")
